...
├── http/
│   ├── controllers/
│   │   ├── auth/            # auth routes + controllers (login, logout, refresh, me)
│   │   ├── users/           # account routes (register, email verification, password reset)
...
stored lowercase), login `identifier` (email or username), `password`
